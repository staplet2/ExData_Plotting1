...
par(mfrow = c(2,2))
with(powerdata_sub, {
    plot(powerdata_sub$DateTime, powerdata_sub$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
    ...
    plot(powerdata_sub$DateTime, powerdata_sub$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
})
